    ...
    <Container className="flex-grow-1">
      {isSmallScreen ? (
        ...
        <div className="mt-2">
          ...
          <TypeBar />
          <BrandBar />
          <Button variant={theme === 'light' ? 'primary' : 'dark'} className="mt-3 mb-3" onClick={onClick}>
            Очистить фильтры
          </Button>
          <DeviceList />
          <Pages />
        ...
        <Row className="mt-2">
          <Col md={3}>
            <FilterDevices />
            <TypeBar />
            <Button variant={theme === 'light' ? 'primary' : 'dark'} className="mt-3" onClick={onClick}>
              Очистить фильтры
            </Button>
          </Col>
          <Col md={9}>
