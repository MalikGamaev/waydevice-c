  ...
  return (
    <Container className="d-flex  flex-column justify-content-center align-items-center mt-3">
      ...
      <Card className="d-flex flex-row  p-2 justify-content-between align-items-center mb-2">
        <h1 className="play-bold pr-2 me-2">Итого:</h1>
        <h2 className="play-bold mb-0">
          {totalAmount}
          <span style={{ color: 'green' }} className="font-weight-light pl-2">
            ₽
          </span>
        </h2>
      </Card>
          ...
          <Row className="d-flex w-100">
            <Col>
              <div className="d-flex flex-row align-items-center">
                <img
                  style={{ borderRadius: theme === 'dark' ? '12px' : '' }}
            ...
            <Col>
              <div className="d-flex h-100 flex-row justify-content-end align-items-center">
                <h2 className="font-weight-light">
                  {product.device.price} <span style={{ color: 'green' }}>₽</span>
                </h2>
